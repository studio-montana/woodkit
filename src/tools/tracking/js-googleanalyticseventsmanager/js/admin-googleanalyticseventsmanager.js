...
(function($) {
	$.googleanalyticseventsmanager = function(element, events) {
		...
		plugin.add_event = function(selector, name, action, category) {
			...
			var html = '';
			html += '<div class="item event" id="googleanalytics-event-id-' + event_id + '">';
			html += '<input type="text" class="small googleanalytics-event-selector" name="googleanalytics-event-selector-' + event_id + '" value="'+selector+'" placeholder="' + settings['label_event_selector'] + '" />';
			html += '<input type="text" class="small googleanalytics-event-name" name="googleanalytics-event-name-' + event_id + '" value="'+name+'" placeholder="' + settings['label_event_name'] + '" />';
			html += '<input type="text" class="small googleanalytics-event-action" name="googleanalytics-event-action-' + event_id + '" value="'+action+'" placeholder="' + settings['label_event_action'] + '" />';
			html += '<input type="text" class="small googleanalytics-event-category" name="googleanalytics-event-category-' + event_id + '" value="'+category+'" placeholder="' + settings['label_event_category'] + '" />';
			html += '<span class="delete delete-event btn" data-id="googleanalytics-event-id-' + event_id + '"><i class="fa fa-times"></i></div><input type="hidden" name="googleanalytics-event-id-' + event_id + '" value="' + event_id + '" /></span>';
			html += '</div>';
