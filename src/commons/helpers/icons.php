...
function get_woodkit_icon($icon_name, $base64 = false, $dataUri = false) {
	...
	switch ($icon_name) {
		case 'bear': 
			$res = '<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120 114" style="enable-background:new 0 0 120 114;" xml:space="preserve"><g><path d="M107.1,25.7l-0.2-0.7c5.1-1.7,8.8-6.5,8.8-12.1C115.7,8.6,110,0,102.9,0c-4.9,0-9,2.7-11.2,6.7C84.1,3.4,73.2,0,60,0S35.9,3.4,28.4,6.7C26.2,2.7,22,0,17.1,0C10,0,4.3,8.6,4.3,12.9c0,5.7,3.7,10.4,8.8,12.1l-0.2,0.7L0,68.6c0,0,0,32.6,60,45.4c60-12.9,60-45.4,60-45.4L107.1,25.7z M60,64.3c0,0-25.7,0-21.4-21.5C43.7,17.3,60,17.1,60,17.1s16.3,0.2,21.4,25.8C85.7,64.3,60,64.3,60,64.3z"/><path d="M69.1,41.8c-2.7-1.4-5.4-1.9-7.9-2v-5.5c0-2.5,5.5-3.1,7.4-3.1c0.7,0,1.2-0.5,1.2-1.2c0-3.4-2-9.8-9.8-9.8c-3.4,0-9.8,2-9.8,9.8c0,0.7,0.5,1.2,1.2,1.2c1.9,0,7.4,0.6,7.4,3.1v5.5c-4.5,0.3-7.7,1.9-7.9,2c-0.6,0.3-0.8,1-0.5,1.6s1,0.8,1.6,0.5c0.1,0,8.2-4,16.1,0c0.2,0.1,0.4,0.1,0.5,0.1c0.4,0,0.9-0.2,1.1-0.7C70,42.8,69.7,42.1,69.1,41.8z"/></g></svg>';
		break;
		case 'bear-plain':
			$res = '<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120 114" style="enable-background:new 0 0 120 114;" xml:space="preserve"><path d="M107.1,25.7l-0.2-0.7c5.1-1.7,8.8-6.5,8.8-12.1C115.7,8.6,110,0,102.9,0c-4.9,0-9,2.7-11.2,6.7C84.1,3.4,73.2,0,60,0S35.9,3.4,28.4,6.7C26.2,2.7,22,0,17.1,0C10,0,4.3,8.6,4.3,12.9c0,5.7,3.7,10.4,8.8,12.1l-0.2,0.7L0,68.6c0,0,0,32.6,60,45.4c60-12.9,60-45.4,60-45.4L107.1,25.7z M69.6,43.4c-0.2,0.4-0.6,0.7-1.1,0.7c-0.2,0-0.4,0-0.5-0.1c-7.9-4-16,0-16.1,0c-0.6,0.3-1.3,0.1-1.6-0.5s-0.1-1.3,0.5-1.6c0.2-0.1,3.4-1.7,7.9-2v-5.5c0-2.6-5.8-3.1-7.4-3.1c-0.7,0-1.2-0.5-1.2-1.2c0-7.7,6.4-9.8,9.8-9.8c7.7,0,9.8,6.4,9.8,9.8c0,0.7-0.5,1.2-1.2,1.2c-1.9,0-7.4,0.6-7.4,3.1v5.5c2.6,0,5.3,0.5,8,1.9C69.7,42.1,69.9,42.8,69.6,43.4z"/></svg>';
		break;
		default: // logo
			$res = '<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120 120" style="enable-background:new 0 0 120 120;" xml:space="preserve"><path d="M60.1,0c-33.1,0-60,26.9-60,60c0,33.1,26.9,60,60,60s60-26.9,60-60C120.1,26.9,93.2,0,60.1,0z M103.8,36.9c1.1,0,2.1,3,2.1,4.1c0,1.1-0.9,2.1-2.1,2.1c-1.1,0-2.1-0.9-2.1-2.1C101.8,39.9,102.7,36.9,103.8,36.9z M88.4,19.9c1.1,0,2.1,3,2.1,4.1c0,1.1-0.9,2.1-2.1,2.1c-1.1,0-2.1-0.9-2.1-2.1C86.3,22.9,87.3,19.9,88.4,19.9z M77.1,41.5c1.1-6,5.8-13.2,10.8-12.4c5,0.9,7.2,9.5,6.2,15.5c-1.1,6-6.7,9.9-11.7,9.1C77.4,52.9,76,47.6,77.1,41.5z M60.1,9.1c1.1,0,2.1,3,2.1,4.1c0,1.1-0.9,2.1-2.1,2.1S58,14.4,58,13.2C58,12.1,58.9,9.1,60.1,9.1z M60.1,19.9c5.1,0,9.3,10,9.3,15.8s-4.1,10.5-9.3,10.5s-9.3-4.7-9.3-10.5S55,19.9,60.1,19.9z M31.8,19.9c1.1,0,2.1,3,2.1,4.1c0,1.1-0.9,2.1-2.1,2.1c-1.1,0-2.1-0.9-2.1-2.1C29.7,22.9,30.6,19.9,31.8,19.9z M32.3,29.2c5-0.9,9.7,6.3,10.8,12.4c1.1,6-0.3,11.3-5.3,12.2c-5,0.9-10.6-2.9-11.7-9C25,38.7,27.2,30.1,32.3,29.2z M16.3,36.9c1.1,0,2.1,3,2.1,4.1c0,1.1-0.9,2.1-2.1,2.1c-1.1,0-2.1-0.9-2.1-2.1C14.2,39.9,15.2,36.9,16.3,36.9z M11.9,62.4c-1.6-4.5,0.3-13.9,4.3-15.4c4-1.5,8.3,7,9.9,11.5c1.6,4.5,1.5,7.3-2.5,8.8C19.6,68.8,13.5,66.9,11.9,62.4z M78.6,101.8c-6.2,0-9.3-3.3-18.5-3.3s-12.4,3.3-18.5,3.3c-9.3,0-17-6.2-17-15.4C24.5,74,38.5,57,60.1,57c21.6,0,35.5,17,35.5,29.4C95.6,95.6,87.9,101.8,78.6,101.8z M96.6,67.3c-4-1.5-4.2-4.3-2.5-8.8c1.6-4.5,5.9-13,9.9-11.5c4,1.5,5.9,10.9,4.3,15.4C106.6,66.9,100.6,68.8,96.6,67.3z"/></svg>';
		break;
	}
