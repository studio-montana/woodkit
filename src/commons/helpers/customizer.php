 ...
 */
function woodkit_customizer_add_control($customizer_obj, $control_slug, $settings_args = array(), $control_args = array(), $multilingual = true){
	if ($multilingual){
 ...
 * @return array of code's languages
 */
function woodkit_customizer_get_langs(){
	static $woodkit_customizer_langs = -1;
	if ($woodkit_customizer_langs === -1){
