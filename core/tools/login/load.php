...
function tool_login_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.LOGIN_TOOL_NAME.'/'.LOGIN_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".LOGIN_TOOL_NAME, "tool_login_activate");