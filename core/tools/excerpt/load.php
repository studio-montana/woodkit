...
function tool_excerpt_get_name($tool_name = ""){
	return __("Excerpt", WOODKIT_PLUGIN_TEXT_DOMAIN);
}
...
function tool_excerpt_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.EXCERPT_TOOL_NAME.'/'.EXCERPT_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".EXCERPT_TOOL_NAME, "tool_excerpt_activate");