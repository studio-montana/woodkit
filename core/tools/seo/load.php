...
function tool_seo_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.SEO_TOOL_NAME.'/'.SEO_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".SEO_TOOL_NAME, "tool_seo_activate");