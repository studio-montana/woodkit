...
function tool_private_get_name($tool_name = ""){
	return __("Private", WOODKIT_PLUGIN_TEXT_DOMAIN);
}
...
function tool_private_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.PRIVATE_TOOL_NAME.'/'.PRIVATE_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".PRIVATE_TOOL_NAME, "tool_private_activate");