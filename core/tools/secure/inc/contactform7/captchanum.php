...
function wpcf7_add_shortcode_captchanum() {
	...
	if (function_exists("wpcf7_add_form_tag")){
		wpcf7_add_form_tag(array('captchanum'),
	...
	<fieldset>
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					<th scope="row"><label
						for="<?php echo esc_attr( $args['content'] . '-useplaceholder' ); ?>"><?php echo esc_html( __( 'Use placeholder', 'contact-form-7' ) ); ?>
					</label></th>
					<td><input type="checkbox" name="useplaceholder"
						class="tg-useplaceholder option"
						id="<?php echo esc_attr( $args['content'] . '-useplaceholder' ); ?>"
						checked="checked" /></td>
				</tr>
				<tr>
					<th scope="row"><label
						for="<?php echo esc_attr( $args['content'] . '-uselabel' ); ?>"><?php echo esc_html( __( 'Use label', 'contact-form-7' ) ); ?>
					</label></th>
					<td><input type="checkbox" name="uselabel"
						class="tg-uselabel option"
						id="<?php echo esc_attr( $args['content'] . '-uselabel' ); ?>" />
					</td>
				</tr>
			</tbody>
		</table>
