...
function tool_logo_get_name($tool_name = ""){
	return __("Logo", WOODKIT_PLUGIN_TEXT_DOMAIN);
}
...
function tool_logo_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.LOGO_TOOL_NAME.'/'.LOGO_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".LOGO_TOOL_NAME, "tool_logo_activate");