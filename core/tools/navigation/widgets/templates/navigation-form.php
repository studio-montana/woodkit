...
<table class="tool-navigation-widget-options">
	<tr>
		<td>
			<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e('Order by', WOODKIT_PLUGIN_TEXT_DOMAIN); ?> : </label>
		</td>
		<td>
	...
	<tr>
		<td>
			<label for="<?php echo $this->get_field_id('order'); ?>"><?php echo __("Order", WOODKIT_PLUGIN_TEXT_DOMAIN); ?> : </label>
		</td>
		<td>
