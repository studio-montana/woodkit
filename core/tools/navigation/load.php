...
function tool_navigation_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.NAVIGATION_TOOL_NAME.'/'.NAVIGATION_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".NAVIGATION_TOOL_NAME, "tool_navigation_activate");