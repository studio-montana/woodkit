...
class tool_googlemaps_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$template = locate_ressource(WOODKIT_PLUGIN_TOOLS_FOLDER.MAPS_TOOL_NAME.'/widgets/templates/googlemaps-widget-output.php');
		if (!empty($template))
			include($template);
	...
	public function form( $instance ) {
		...
		// Widget admin form
		$template = locate_ressource('/'.WOODKIT_PLUGIN_TOOLS_FOLDER.MAPS_TOOL_NAME.'/widgets/templates/googlemaps-widget-form.php');
		if (!empty($template))
			include($template);
	}
