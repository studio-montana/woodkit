...
function tool_display_get_name($tool_name = ""){
	return __("Display", WOODKIT_PLUGIN_TEXT_DOMAIN);
}
...
function tool_display_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.DISPLAY_TOOL_NAME.'/'.DISPLAY_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".DISPLAY_TOOL_NAME, "tool_display_activate");