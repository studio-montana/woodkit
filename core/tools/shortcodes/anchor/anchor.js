(function() {
	tinymce.create('tinymce.plugins.toolshortcodesanchor', {
		/**
		...
		init : function(ed, url) {
			ed.addButton('toolshortcodesanchor', {
				title : 'Anchor',
				cmd : 'toolshortcodesanchor',
				icon : 'none fa fa-anchor'
			});

			ed.addCommand('toolshortcodesanchor', function() {
				ed.execCommand('mceInsertContent', 0, '[anchor name="your-anchor"/]');
			});
		},
		...
		getInfo : function() {
			return {
				longname : 'Woodkit Anchor Shortcode',
	...
	// Register plugin
	tinymce.PluginManager.add('toolshortcodesanchor', tinymce.plugins.toolshortcodesanchor);
})();