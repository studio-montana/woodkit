...
function tool_shortcodes_get_name($tool_name = ""){
	return __("Shortcodes", WOODKIT_PLUGIN_TEXT_DOMAIN);
}
...
function tool_shortcodes_activate(){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/'.SHORTCODES_TOOL_NAME.'.php');
}
add_action("woodkit_tool_activate_".SHORTCODES_TOOL_NAME, "tool_shortcodes_activate");