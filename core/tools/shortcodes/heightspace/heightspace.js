(function() {
	tinymce.create('tinymce.plugins.toolshortcodesheightspace', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addCommand('toolshortcodesheightspace', function() {
				ed.execCommand('mceInsertContent', 0, '[heightspace height="36px"/]');
			});
		},
		...
		getInfo : function() {
			return {
				longname : 'Woodkit HeightSpace Shortcode',
	...
	// Register plugin
	tinymce.PluginManager.add('toolshortcodesheightspace', tinymce.plugins.toolshortcodesheightspace);
})();