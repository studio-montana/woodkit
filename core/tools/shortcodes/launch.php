...
/**
 * LAUNCH shortcode if enable
 */
$tool_shortcodes_enable = woodkit_get_tool_option('shortcodes', 'enable-exergue');
if ($tool_shortcodes_enable == 'on'){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/exergue/exergue.php');
}
$tool_shortcodes_enable = woodkit_get_tool_option('shortcodes', 'enable-heightspace');
if ($tool_shortcodes_enable == 'on'){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/heightspace/heightspace.php');
}
$tool_shortcodes_enable = woodkit_get_tool_option('shortcodes', 'enable-icons');
if ($tool_shortcodes_enable == 'on'){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/icons/icons.php');
}
$tool_shortcodes_enable = woodkit_get_tool_option('shortcodes', 'enable-anchor');
if ($tool_shortcodes_enable == 'on'){
	require_once (WOODKIT_PLUGIN_PATH.WOODKIT_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/anchor/anchor.php');
}
$tool_shortcodes_enable = woodkit_get_tool_option('shortcodes', 'enable-columns');
if ($tool_shortcodes_enable == 'on'){
