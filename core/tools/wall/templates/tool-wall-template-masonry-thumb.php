...
if (has_post_thumbnail(get_the_ID())){
	...
	$thumbnail = wp_get_attachment_image_src($thumbnail_id, $wall_args['image_size']);
	...
	<?php } ?>
		<div class="inner-item-wrapper" style="width: 100%; height: 100%;">
			<div class="inner-item thumb" style="<?php echo $style_thumb; ?>">
				...
				$template = locate_ressource(WOODKIT_PLUGIN_TOOLS_FOLDER.WALL_TOOL_NAME.'/templates/tool-wall-template-masonry-thumb-inner.php');
				if (!empty($template)){
					include($template);
				}else{
					?>
