...
function customfields_admin_init() {
	...
	foreach ($customfields_posttypes_available as $post_type){
		...
		add_meta_box('woodkit-customfields', '<i class="fa fa-rocket" style="margin-right: 6px;"></i>'.__('Woodkit', WOODKIT_PLUGIN_TEXT_DOMAIN), 'customfields_add_inner_meta_boxes', $post_type, 'normal', $metabox_position);
	}
}
